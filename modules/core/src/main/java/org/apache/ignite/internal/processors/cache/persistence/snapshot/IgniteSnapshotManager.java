...
import static org.apache.ignite.internal.processors.cache.persistence.snapshot.SnapshotDistributedProcess.finishClusterFutureWithErr;
...
public class IgniteSnapshotManager extends GridCacheSharedManagerAdapter
    ...
    final SnapshotDistributedProcess checkSnpProc;
    ...
    public IgniteSnapshotManager(GridKernalContext ctx) {
        ...
        checkSnpProc = new SnapshotDistributedProcess(ctx);
