...
public class GridDhtAtomicCache<K, V> extends GridDhtCacheAdapter<K, V> {
    ...
    private void updateAllAsyncInternal0(
        ...
        try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (!remap) {
                                ...
                                res.remapTopologyVersion(top.lastTopologyChangeVersion(), ctx.kernalContext().isStopping());
                            }
                        }
                        finally {
                            top.readUnlock();
            ...
            res.remapTopologyVersion(ctx.topology().lastTopologyChangeVersion(), ctx.kernalContext().isStopping());
        }
        catch (Throwable e) {
